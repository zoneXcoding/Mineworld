...
public class UIMenuConfigVideo extends UIWindow {
    ...
    public UIMenuConfigVideo() {
            ...
            public void action(UIDisplayElement element) {
                ...
                switch (button.getState()) {
                    case 0:
                        ...
                        config.getRendering().setVignette(false);
                        ...
                        config.getRendering().setOutline(false);
        ...
        graphicsQualityButton.addState("Graphics Quality: Fast", graphicsQualityStateAction);
        graphicsQualityButton.addState("Graphics Quality: Fancy", graphicsQualityStateAction);
